...
namespace {
void agent_enable_all(struct agent *agt)
{
	for (auto *aevent :
 ...
 */
namespace {
int add_filter_app_ctx(struct lttng_bytecode *bytecode,
...
namespace {
int agent_enable(struct agent *agt,
		 struct lttng_event *event,
		 struct lttng_bytecode *filter,
		 char *filter_expression,
		 const lttng::sessiond::config::event_rule_configuration *ust_event_rule_config)
...
namespace {
int trigger_agent_disable_one(const struct lttng_trigger *trigger,
			      struct agent *agt,
			      struct agent_event *aevent)
 ...
 */
namespace {
int event_agent_disable_one(lttng::sessiond::ust::domain_orchestrator& orchestrator,
			    struct agent *agt,
			    struct agent_event *aevent)
{
	int ret;
