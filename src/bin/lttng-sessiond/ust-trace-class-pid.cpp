...
lttng_buffer_type lsu::trace_class_per_pid::buffering_scheme() const noexcept
{
	return LTTNG_BUFFER_PER_PID;
}

void lsu::trace_class_per_pid::accept(lst::trace_class_environment_visitor& visitor) const
{
