...
{
	fprintf(ofp, "Usage: lttng snapshot <action> [options]\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "Help options:\n");
	fprintf(ofp, "  -h, --help          Show this help\n");
	fprintf(ofp, "      --list-options  Simple listing of options\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "Available actions:\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  add-output [-m SIZE] [-s SESSION] [-n NAME] <url>\n");
	fprintf(ofp, "  add-output [-m SIZE] [-s SESSION] [-n NAME] -C URL -D URL\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Setup and add a snapshot output for a session.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Options:\n");
	fprintf(ofp, "      -C, --ctrl-url URL     Set control path URL to URL (must use\n");
	fprintf(ofp, "                             -D, --data-url option also)\n");
	fprintf(ofp, "      -D, --data-url URL     Set data path URL to URL (must use -C, --ctrl-url\n");
	fprintf(ofp, "                             option also)\n");
	fprintf(ofp, "      -m, --max-size SIZE    Set snapshot's maximum size to SIZE bytes\n");
	fprintf(ofp, "                             ('k', 'M', and 'G' suffixes can be used)\n");
	fprintf(ofp, "      -n, --name NAME        Name of the output or snapshot\n");
	fprintf(ofp, "      -s, --session SESSION  Apply to session SESSION\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  del-output [-s SESSION] <id>\n");
	fprintf(ofp, "  del-output [-s SESSION] <name>\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Delete an output for a session using the <id> or the name <name>.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Options:\n");
	fprintf(ofp, "      -s, --session SESSION  Apply to session SESSION\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  list-output [-s SESSION]\n");
	fprintf(ofp, "\n");
	...
	fprintf(ofp, "      -s, --session SESSION  Apply to session SESSION\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  record [-m SIZE] [-s NAME] [-n NAME] [<url>]\n");
	fprintf(ofp, "  record [-m SIZE] [-s NAME] [-n NAME] [-C URL -D URL]\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Take a snapshot of a session's buffer(s) for all domains. If <url> is\n");
	fprintf(ofp, "    specified, it is used instead of a previously added output. Specifying only\n");
	fprintf(ofp, "    a name or/a size will override the current output value. For instance,\n");
	fprintf(ofp, "    you can record a snapshot with a custom maximum size or with a\n");
	fprintf(ofp, "    different name.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Options:\n");
	fprintf(ofp, "      -C, --ctrl-url URL     Set control path URL to URL (must use\n");
	fprintf(ofp, "                             -D, --data-url option also)\n");
