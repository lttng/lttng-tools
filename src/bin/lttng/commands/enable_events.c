...
{
	fprintf(ofp, "Usage: lttng enable-event <name>[,<name2>,...] (-k | -u | -j | -l | -p) [opts]\n");
	fprintf(ofp, "\n");
	...
	fprintf(ofp, "\n");
	fprintf(ofp, "Event type options:\n");
	fprintf(ofp, "  -a, --all                 Enable all tracepoint and system call events\n");
	fprintf(ofp, "      --function (ADDR | SYMBOL | SYMBOL+OFFSET)\n");
	fprintf(ofp, "                            Dynamic function entry/return probe event. ADDR and\n");
	fprintf(ofp, "                            OFFSET can be octal (0NNN...), decimal (NNN...), or\n");
	fprintf(ofp, "                            hexadecimal (0xNNN...).\n");
	fprintf(ofp, "      --probe (ADDR | SYMBOL | SYMBOL+OFFSET)\n");
	fprintf(ofp, "                            Dynamic probe event. ADDR and OFFSET can be octal\n");
	fprintf(ofp, "                            (0NNN...), decimal (NNN...), or hexadecimal\n");
	fprintf(ofp, "                            (0xNNN...).\n");
	fprintf(ofp, "      --syscall             System call event\n");
	fprintf(ofp, "      --tracepoint          Tracepoint event (default). User space tracer\n");
	fprintf(ofp, "                            supports wildcards at end of string. Don't forget to\n");
	fprintf(ofp, "                            quote to deal with shell expansion (e.g., 'app:n*').\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "Log level options:\n");
	fprintf(ofp, "      --loglevel NAME       Tracepoint log level is at least as important as\n");
	fprintf(ofp, "                            log level NAME (ranges from 0 to the numeric value\n");
	fprintf(ofp, "                            of log level NAME). Wildcard is supported at the\n");
	fprintf(ofp, "                            end of NAME. See the tables below for available\n");
	fprintf(ofp, "                            log level names.\n");
	fprintf(ofp, "      --loglevel-only NAME  Tracepoint log level is exactly NAME. Wildcard is\n");
	fprintf(ofp, "                            supported at the end of NAME. See the tables below\n");
	fprintf(ofp, "                            for available log level names.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "Filtering options:\n");
	fprintf(ofp, "  -f, --filter EXPR         Filter events on fields and context using expression\n");
	fprintf(ofp, "                            EXPR. See lttng(1) for filter expression format.\n");
	fprintf(ofp, "  -x, --exclude LIST        Exclude events listed in comma-separated LIST.\n");
	fprintf(ofp, "                            Events that match any of the items are not enabled,\n");
	fprintf(ofp, "                            even if they match a wildcard definition of\n");
	fprintf(ofp, "                            the event.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "Help options:\n");
	fprintf(ofp, "  -h, --help                Show this help\n");
	fprintf(ofp, "      --list-options        List options\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "Available log levels:\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  User space domain (-u, --userspace option):\n");
	fprintf(ofp, "\n");
	...
	fprintf(ofp, "\n");
	fprintf(ofp, "  JUL domain (-j, --jul option):\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    JUL_OFF      INT32_MAX\n");
	fprintf(ofp, "    JUL_SEVERE   1000\n");
	fprintf(ofp, "    JUL_WARNING  900\n");
	fprintf(ofp, "    JUL_INFO     800\n");
	fprintf(ofp, "    JUL_CONFIG   700\n");
	fprintf(ofp, "    JUL_FINE     500\n");
	fprintf(ofp, "    JUL_FINER    400\n");
	fprintf(ofp, "    JUL_FINEST   300\n");
	fprintf(ofp, "    JUL_ALL      INT32_MIN\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    Shortcuts such as \"severe\" are allowed.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  log4j domain (-l, --log4j option):\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    LOG4J_OFF    INT32_MAX\n");
	fprintf(ofp, "    LOG4J_FATAL  50000\n");
	fprintf(ofp, "    LOG4J_ERROR  40000\n");
	fprintf(ofp, "    LOG4J_WARN   30000\n");
	fprintf(ofp, "    LOG4J_INFO   20000\n");
	fprintf(ofp, "    LOG4J_DEBUG  10000\n");
	fprintf(ofp, "    LOG4J_TRACE  5000\n");
	fprintf(ofp, "    LOG4J_ALL    INT32_MIN\n");
	fprintf(ofp, "    \n");
	fprintf(ofp, "    Shortcuts such as \"severe\" are allowed.\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "  Python domain (-p, --python option):\n");
	fprintf(ofp, "\n");
	fprintf(ofp, "    PYTHON_CRITICAL  50\n");
	fprintf(ofp, "    PYTHON_ERROR     40\n");
	fprintf(ofp, "    PYTHON_WARNING   30\n");
	fprintf(ofp, "    PYTHON_INFO      20\n");
	fprintf(ofp, "    PYTHON_DEBUG     10\n");
	fprintf(ofp, "    PYTHON_NOTSET    0\n");
	fprintf(ofp, "\n");
