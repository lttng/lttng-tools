...
namespace {
void lttng_event_rule_jul_logging_destroy(struct lttng_event_rule *rule)
{
...
bool lttng_event_rule_jul_logging_validate(const struct lttng_event_rule *rule)
{
	bool valid = false;
	struct lttng_event_rule_jul_logging *jul_logging;
...
int lttng_event_rule_jul_logging_serialize(const struct lttng_event_rule *rule,
...
bool lttng_event_rule_jul_logging_is_equal(const struct lttng_event_rule *_a,
...
const char *lttng_event_rule_jul_logging_get_internal_filter(const struct lttng_event_rule *rule)
{
	struct lttng_event_rule_jul_logging *jul_logging;
...
const char *lttng_event_rule_jul_logging_get_filter_expression(const struct lttng_event_rule *rule)
{
	struct lttng_event_rule_jul_logging *jul_logging;

	LTTNG_ASSERT(rule);
	jul_logging = lttng::utils::container_of(rule, &lttng_event_rule_jul_logging::parent);
	return jul_logging->filter_expression;
}
...
unsigned long lttng_event_rule_jul_logging_hash(const struct lttng_event_rule *rule)
{
	unsigned long hash;
...
enum lttng_error_code lttng_event_rule_jul_logging_mi_serialize(const struct lttng_event_rule *rule,
...
struct lttng_event_rule *lttng_event_rule_jul_logging_create(void)
{
	...
	tp_rule->parent.get_internal_filter = lttng_event_rule_jul_logging_get_internal_filter;
	tp_rule->parent.get_filter_expression = lttng_event_rule_jul_logging_get_filter_expression;
...
namespace {
bool log_level_rule_valid(const struct lttng_log_level_rule *rule __attribute__((unused)))
{
	/*
