...
namespace {
void lttng_event_rule_python_logging_destroy(struct lttng_event_rule *rule)
{
...
bool lttng_event_rule_python_logging_validate(const struct lttng_event_rule *rule)
{
	bool valid = false;
	struct lttng_event_rule_python_logging *python_logging;
...
int lttng_event_rule_python_logging_serialize(const struct lttng_event_rule *rule,
...
bool lttng_event_rule_python_logging_is_equal(const struct lttng_event_rule *_a,
...
const char *lttng_event_rule_python_logging_get_internal_filter(const struct lttng_event_rule *rule)
{
	struct lttng_event_rule_python_logging *python_logging;
...
unsigned long lttng_event_rule_python_logging_hash(const struct lttng_event_rule *rule)
{
	unsigned long hash;
