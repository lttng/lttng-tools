...
namespace {
void lttng_event_rule_log4j_logging_destroy(struct lttng_event_rule *rule)
{
...
bool lttng_event_rule_log4j_logging_validate(const struct lttng_event_rule *rule)
{
	bool valid = false;
	struct lttng_event_rule_log4j_logging *log4j_logging;
...
int lttng_event_rule_log4j_logging_serialize(const struct lttng_event_rule *rule,
...
bool lttng_event_rule_log4j_logging_is_equal(const struct lttng_event_rule *_a,
...
const char *lttng_event_rule_log4j_logging_get_internal_filter(const struct lttng_event_rule *rule)
{
	struct lttng_event_rule_log4j_logging *log4j_logging;
...
const char *
lttng_event_rule_log4j_logging_get_filter_expression(const struct lttng_event_rule *rule)
{
	struct lttng_event_rule_log4j_logging *log4j_logging;

	LTTNG_ASSERT(rule);
	log4j_logging = lttng::utils::container_of(rule, &lttng_event_rule_log4j_logging::parent);
	return log4j_logging->filter_expression;
}
...
unsigned long lttng_event_rule_log4j_logging_hash(const struct lttng_event_rule *rule)
{
	unsigned long hash;
...
struct lttng_event_rule *lttng_event_rule_log4j_logging_create(void)
{
	...
	tp_rule->parent.get_internal_filter = lttng_event_rule_log4j_logging_get_internal_filter;
	tp_rule->parent.get_filter_expression =
		lttng_event_rule_log4j_logging_get_filter_expression;
