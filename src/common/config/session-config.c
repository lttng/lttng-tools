...
const char * const config_element_userspace_probe_type = "type";
const char * const config_element_userspace_probe_type_function = "Function";
const char * const config_element_userspace_probe_type_tracepoint = "Tracepoint";
const char * const config_element_userspace_probe_attributes = "userspace_probe_attributes";
const char * const config_element_userspace_probe_binary_path = "binary_path";
const char * const config_element_userspace_probe_function_name = "function_name";
const char * const config_element_userspace_probe_lookup = "lookup_method";
const char * const config_element_userspace_probe_lookup_default = "Default";
const char * const config_element_userspace_probe_lookup_elf = "ELF";
const char * const config_element_userspace_probe_lookup_sdt = "SDT";
const char * const config_element_userspace_probe_tracepoint_provider = "provider";
const char * const config_element_userspace_probe_tracepoint_probename = "probe";
