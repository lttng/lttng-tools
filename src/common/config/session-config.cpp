...
const char *const config_element_map_channel = "map_channel";
const char *const config_element_map_channels = "map_channels";
const char *const config_element_map_channel_key_type = "key_type";
const char *const config_element_map_channel_key_type_string = "STRING";
const char *const config_element_map_channel_key_type_index = "INDEX";
const char *const config_element_map_channel_value_type = "value_type";
const char *const config_element_map_channel_value_type_signed_int_32 = "SIGNED_INT_32";
const char *const config_element_map_channel_value_type_signed_int_64 = "SIGNED_INT_64";
const char *const config_element_map_channel_value_type_signed_int_max = "SIGNED_INT_MAX";
const char *const config_element_map_channel_update_policy = "update_policy";
const char *const config_element_map_channel_update_policy_per_event = "PER_EVENT";
const char *const config_element_map_channel_update_policy_per_rule_match = "PER_RULE_MATCH";
const char *const config_element_map_channel_max_entry_count = "max_entry_count";
const char *const config_element_map_channel_buffer_ownership = "buffer_ownership";
const char *const config_element_map_channel_buffer_ownership_per_uid = "PER_UID";
const char *const config_element_map_channel_buffer_ownership_per_pid = "PER_PID";
const char *const config_element_map_channel_dead_group_policy = "dead_group_policy";
const char *const config_element_map_channel_dead_group_policy_drop = "DROP";
const char *const config_element_map_channel_dead_group_policy_sum_into_shared = "SUM_INTO_SHARED";
			 ...
			 const struct config_load_session_override_attr *overrides)
{
	...
	if (snapshot_mode && snapshot_mode != -1) {
		...
		/* regular session */
		ret = create_session(
			(const char *) name, output_node, trace_format, UINT64_MAX, overrides);
	}
	if (ret) {
		goto error;
	}
