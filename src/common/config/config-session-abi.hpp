...
extern const char *const config_element_map_channel;
extern const char *const config_element_map_channels;
extern const char *const config_element_map_channel_key_type;
extern const char *const config_element_map_channel_key_type_string;
extern const char *const config_element_map_channel_key_type_index;
extern const char *const config_element_map_channel_value_type;
extern const char *const config_element_map_channel_value_type_signed_int_32;
extern const char *const config_element_map_channel_value_type_signed_int_64;
extern const char *const config_element_map_channel_value_type_signed_int_max;
extern const char *const config_element_map_channel_update_policy;
extern const char *const config_element_map_channel_update_policy_per_event;
extern const char *const config_element_map_channel_update_policy_per_rule_match;
extern const char *const config_element_map_channel_max_entry_count;
extern const char *const config_element_map_channel_buffer_ownership;
extern const char *const config_element_map_channel_buffer_ownership_per_uid;
extern const char *const config_element_map_channel_buffer_ownership_per_pid;
extern const char *const config_element_map_channel_dead_group_policy;
extern const char *const config_element_map_channel_dead_group_policy_drop;
extern const char *const config_element_map_channel_dead_group_policy_sum_into_shared;
...
extern const char *const config_element_channel_reclaim_policy;
extern const char *const config_element_channel_reclaim_policy_periodic;
extern const char *const config_element_channel_reclaim_policy_periodic_age_threshold;
extern const char *const config_element_channel_reclaim_policy_consumed;
